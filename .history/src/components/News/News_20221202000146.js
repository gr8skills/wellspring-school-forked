      ...
      <div className="col-md-12 flexy news-container">
        ...
        <div className="col-md-10 flexy">
          ...
          <div className="col-md-6 news-description">
            ...
            <p>
              <strong>
                Wellspringl dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl
                dskldmellspringl dskldmellspringl dskldmellspringl dskldm
              </strong>
            </p>
