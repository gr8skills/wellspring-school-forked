  ...
  return (
    <>
      ...
      <div className="col-md-12 flexy">
        <div className="col-md-3">&nbsp;</div>
        <div className="col-md-6">
          <Heading size="sm" mb="30px" mt="10px">
           About Us
          </Heading>
          <p>Founded in 2003, today Wellspring College proudly welcomes over 650 students representing different ethnicities, embracing a vision of transformative learning and a culture of excellence. Through rich enhancements in curricular and extracurricular activities, we strive to provide good education, one that grooms our students to be globally competitive and exceptional leaders. We ensure that students are equipped with requisite 21st century skills by which they are empowered to provide winning solutions for tomorrow’s challenges.

At Wellspring College, we seek every occasion to provide our students with opportunities for sound academic, mental, spiritual and social development.We ensure that for our students learning is not a challenge, it’s interesting, it’s fun, it’s hands-on.

We continuously train unique, and exceptional students, which gives them the leverage to be distinct amongst their pears.</p>
        </div>
      </div>
      <StayConnected />
    </>
