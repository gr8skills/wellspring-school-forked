...
import Users from "../../assets/profile2users.png";
...
export const Admission = () => {
  return (
    <>
      ...
      <Prospectus />
      <div className="col-md-12 flexy achievements">
        <div className="col-md-1">&nbsp;</div>
        ...
        <div className="col-md-5">
          <div className="col-md-12 flexy flexyM">
            <img className="col-md-12" src={Graduate} alt="Scholar" />
            <div>
              <h1>Awarded 3rd Best</h1>
              <p>in Lagos WAEC, 2015</p>
            </div>
          </div>
        </div>
      </div>
