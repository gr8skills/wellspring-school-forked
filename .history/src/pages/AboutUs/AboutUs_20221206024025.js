      ...
      <div className="col-md-12 flexy">
        ...
        <div className="page-body col-md-7">
          ...
          <p>
            ...
            challenges.</p> <p>At Wellspring College, we seek every occasion to provide
            our students with opportunities for sound academic, mental,
            spiritual and social development. </p> <p>We ensure that for our students
            learning is  not a challenge, it’s interesting, it’s fun, it’s
            hands-on. <br /> <br /> We continuously train unique, and exceptional students,
            which gives them the leverage to be distinct amongst their pears.
          </p>
        </div>
      </div>
    </>
