...
export const AboutUs = () => {
  return (
    <>
      ...
      <div className="col-md-12 flexy" style={{marginTop:""}}>
        <div className="col-md-3">&nbsp;</div>
        <div className="col-md-6 flexy">
          <div className="col-md-6 holder2">
            <a href="#">
              {" "}
              <img className="col-md-9 " src={Song} alt="Scholar" />
              <div className="overlay2">
                <h5>Discipline</h5>
              </div>
            </a>
          </div><div className="col-md-6 holder2">
            <a href="#">
              {" "}
              <img className="col-md-9 " src={Team} alt="Scholar" />
              <div className="overlay2">
                <h5>Discipline</h5>
              </div>
            </a>
