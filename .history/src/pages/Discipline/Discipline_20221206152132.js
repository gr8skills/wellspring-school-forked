      ...
      <div className="col-md-12 flexy vision">
        ...
        <div className="page-body col-md-8 ">
          <p>
            ...
            respect for parents, authorities, and other people’s rights. We
            reaffirm exemplary behavior by public recognition of the assembly
            and rewarding with merit points. As we mold and build the characters
            of tomorrow’s leaders, we impart in them discipline and values which
            are deep-rooted in the love of Christ. All rules and regulations are
            enforced with love.
          </p>
          <StayConnected />
        </div>
