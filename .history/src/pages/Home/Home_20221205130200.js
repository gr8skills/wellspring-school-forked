...
export const Home = () => {
  return (
    <>
      ...
      <div className="col-md-12 prospectus-container">
        <div className="col-md-1">&nbsp;</div>
        <div className="col-md-10 prospectus">
          <h1>
            {" "}
            position: absolute; right: 0; bottom: 10px; left: 0; z-index: 15;
            display: flex; flex-direction: row; height: 100%; justify-content:
            center; padding-left: 0; margin-right: 0; margin-left: 1vw;
            list-style: none; outline: none; border: none;
          </h1>
        </div>
      </div>
