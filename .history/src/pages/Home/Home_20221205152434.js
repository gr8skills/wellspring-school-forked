  ...
  return (
    <>
      ...
      <div className="upcoming-events">
        <CalendarCarousel show={3.5} slide={3} swiping={true}>
          {/* <Calendar
            month="Nov"
            day="10"
            year="2022"
          ...
          <a color="#2d66c3">We love Web 🌐</a>
          <a color="#f44336">We love Developers 👩🏻‍</a>
          <a target="_blank" href="https://github.com/trendyol/">
            <a color="#d53f8c">This is our github</a>
          </a>
          <a target="_blank" href="https://trendyol.com/">
            <a color="#f27a1a">This is our website</a>
          </a>
        </CalendarCarousel>
      </div>
    </>
