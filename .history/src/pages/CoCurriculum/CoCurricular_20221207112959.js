...
import Blue2 from "../../assets/blue-double.png";
      ...
      <div className="col-md-12 flexy">
        ...
        <div className="col-md-10 flexy">
          <div className="col-md-6">
            <img className="col-md-12" src={Blue} alt="Scholar" />
            <Heading size="md" mb="30px" mt="30px">
            ...
            <img className="col-md-12" src={Draw} alt="Scholar" />
          </div>
        </div>
      </div>
      <StayConnected />
