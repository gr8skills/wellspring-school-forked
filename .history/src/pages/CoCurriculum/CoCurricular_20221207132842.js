    ...
    <div className="col-md-12 flexy extra-content">
      ...
      <div className="col-md-10 flexy">
        <div className="col-md-6 ">
          ...
          <p>
            As an offshoot of the Federal Road Safety Commission, the Wellspring
            Junior Road Safety Corps seeks to expose its members to the rules
            that guide the use of public roads and the attitudes expected of all
            road users in the country. The club ensures discipline, orderliness,
            and safety within the school premises and at events organized by the
            school. Membership of the club helps to engender within the members,
            a sense of social responsibility, preparing them as potential agents
            of societal change.
          </p>
          <img className="col-md-12 mt6" src={Blue2} alt="Scholar" />
          <Heading size="lg" mb="30px" mt="30px">
        ...
        <div className="col-md-6">
          ...
          <p>
            ...
            provides vocal coaching and training on how to play various musical
            instruments. The members are thus able to discover their musical
            talents as they sing and play local and foreign musical instruments.
            The club members stage multilingual choral presentations and dance
          ...
          <p>
            This club was formed to make notable changes in the attitude of our
            youth towards farming. Members are kept in touch with their
