    ...
    <>
      ...
      <div className="col-md-12 flexy">
        ...
        <div className="page-body col-md-8 ">
          ...
          <p> At Wellspring College, we emphasize academic and moral excellence. We are committed to turning out youths who are not only academically sound but also of unquestionable character.</p>
        </div>
