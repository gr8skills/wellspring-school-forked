      ...
      <div className="col-md-12 flexy">
        ...
        <div className="page-body col-md-8 ">
          ...
          <p style={{ textAlign: "center" }}>
            ...
            given to us as the 3rd Best School in Lagos State in 2015 WASSCE by
            WAEC.
          </p>
          <br />
          <br />
          ...
          <br />
          <p style={{ textAlign: "center" }}>
            Above all, we are guided by the truth that if the Lord is not in
            charge, the builders labour in vain (Psalm 127:1) hence, our utmost
            reliance in GOD who is forever faithful.
          </p>
        </div>
        <div className="col-md-2 side-menu">
          ...
          <ul className="list-unstyled">
            ...
            <li className="active">
              <Link to={"/proprietor-m"}> Principal’s Message</Link>
            </li>
            <li>
