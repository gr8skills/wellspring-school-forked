  ...
  return (
    <>
      {/* <div className="read-more-wrap">
        <div className="col-md-12 holder read-more-wrap">
          ...
          <div className="page-body col-md-5 ">
            ...
            <div className="page-body col-md-8 col-12">
              ...
              <p>
                ...
                themselves in the art of articulating their opinions in public,
                thus enhancing their speaking, listening, and writing skills.
                This is achieved through the media of debate, talk shows,
                quizzes, spelling, and writing competitions.
              </p>
            </div>
          </div>
            ...
            <div className="col-md-6 ">
              <div className="col-md-11">
                ...
                <p>
                  ...
                  that they might have for the subject. Shapes and figures club
                  draws students to mathematics. All students are required to be
            ...
            <div className="col-md-6">
              <div className="col-md-11">
                ...
                <p>
                  ...
                  confidence as they participate in in-house and external drama
                  presentations.
                </p>
                <img className="col-md-12 mt6 mb6" src={Blue} alt="Scholar" />{" "}
              </div>
          ...
          <div className="col-md-10 flexy">
            <div className="col-md-6 ">
              <div className="col-md-11">
                ...
                <p>
                  ...
                  Membership of the club helps to engender within the members, a
                  sense of social responsibility, preparing them as potential
            ...
            <div className="col-md-6">
              <div className="col-md-11">
                ...
                <p>
                  For the purpose of making each student a more valuable member
                  of the family, this club teaches the members several ways
                  through which they can make meaningful domestic contributions.
                ...
                <p>
                  ...
                  the mind and creates a generally peaceful atmosphere. The
                  music club provides vocal coaching and training on how to play
                  various musical instruments. The members are thus able to
                  discover their musical talents as they sing and play local and
                  foreign musical instruments. The club members stage
                  multilingual choral presentations and dance performances at
                  the school’s events
                </p>
