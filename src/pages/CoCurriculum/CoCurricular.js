...
export const CoCurricular = () => {
  ...
  const extraContent = (
    <>
      {" "}
      <div
        className={`col-md-12 flexy extra-content ${
          readMore ? "fadeIn" : "fadeOut"
        }`}
      >
        ...
        <div className="col-md-10 flexy">
          <div className="col-md-6 ">
            <div className="col-md-11">
              ...
              <p>
                ...
                members to appreciate and portray aesthetics through the
                techniques of drawing, painting, and designing. Art club members
                have represented the school and won laurels at a number of art
                competitions.
              </p>
              <img className="col-md-12 mt6" src={Blue2} alt="Scholar" />
              <Heading size="lg" mb="30px" mt="30px">
              ...
              <p>
                ...
                Wellspring Junior Road Safety Corps seeks to expose its members
                to the rules that guide the use of public roads and the
                attitudes expected of all road users in the country. The club
                ensures discipline, orderliness, and safety within the school
                premises and at events organized by the school. Membership of
                the club helps to engender within the members, a sense of social
                responsibility, preparing them as potential agents of societal
                change.
              </p>
              <img className="col-md-12 mt6" src={Blue2} alt="Scholar" />
              <Heading size="lg" mb="30px" mt="30px">
              ...
              <p>
                ...
                promote the speaking, reading, and writing of French among its
                members.
              </p>
              <img className="col-md-12 mt6" src={Blue2} alt="Scholar" />
            </div>
          ...
          <div className="col-md-6">
            <div className="col-md-11">
              ...
              <p>
                For the purpose of making each student a more valuable member of
                the family, this club teaches the members several ways through
                which they can make meaningful domestic contributions.
                Activities include meal planning, cooking and serving food
              </p>
              ...
              <p>
                ...
                which they address critical societal issues. The members develop
                an appreciation for the performing arts and gain confidence as
                they participate in in-house and external drama presentations.
              </p>
              ...
              <p>
                Music is soothing to the soul as it enhances the stability of
                the mind and creates a generally peaceful atmosphere. The music
                club provides vocal coaching and training on how to play various
                musical instruments. The members are thus able to discover their
                musical talents as they sing and play local and foreign musical
                instruments. The club members stage multilingual choral
                presentations and dance performances at the school’s events
              </p>
              <img className="col-md-12 mt6 mb6" src={Music} alt="Scholar" />
              <Heading size="lg" mb="30px" mt="30px">
                Young Farmers Club{" "}
              </Heading>
              <p>
                This club was formed to make notable changes in the attitude of
                our youth towards farming. Members are kept in touch with their
                agricultural heritage by encouraging them to do practical
                agricultural work on the school farmland and poultry.
              </p>
              <img className="col-md-12 mt6 mb6" src={Blue} alt="Scholar" />
            </div>
          </div>
          ...
          <div className="col-md-6 ">
            <div className="col-md-11">
              ...
              <p>
                ...
                interest in Mathematics, thereby reducing the apathy/hatred that
                they might have for the subject. Shapes and figures club draws
                students to mathematics. All students are required to be members
                of this club.
              </p>
