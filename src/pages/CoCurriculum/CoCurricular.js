        ...
        <div className="col-md-6 ">
          <div className="col-md-11">
            ...
            <p>
              ...
              Wellspring Junior Road Safety Corps seeks to expose its members to
              the rules that guide the use of public roads and the attitudes
              expected of all road users in the country. The club ensures
              discipline, orderliness, and safety within the school premises and
              at events organized by the school. Membership of the club helps to
              engender within the members, a sense of social responsibility,
              preparing them as potential agents of societal change.
            </p>
            <img className="col-md-12 mt6" src={Blue2} alt="Scholar" />
            <Heading size="lg" mb="30px" mt="30px">
              French Club{" "}
        ...
        <div className="col-md-6">
          <div className="col-md-11">
            ...
            <p>
              ...
              which they can make meaningful domestic contributions. Activities
              include meal planning, cooking and serving food
            </p>
            ...
            <p>
              Music is soothing to the soul as it enhances the stability of the
              mind and creates a generally peaceful atmosphere. The music club
              provides vocal coaching and training on how to play various
